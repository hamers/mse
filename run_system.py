...
def parse_arguments():
    ...
    parser.add_argument("--tides_viscous_time_scale_prescription",                type=int,      dest="tides_viscous_time_scale_prescription", default=1,       help="Viscous time-scale prescription. 1: Hurley et al. (2002); 2: Preece et al. (2022).")
