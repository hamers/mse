...
int compute_RLOF_emt_model(Particle *p, Particle *donor, Particle *accretor, double x, double E_0)
{
    ...
    if (binary_evolution_mass_transfer_model == 1)
    {
        double c = -2.0*(M_d_dot_av/M_d) * (1.0 - q*beta);
        double sqrt_omesq = sqrt(1.0 - e*e);
        da_dt = c * a * sqrt_omesq;
        de_dt = c * e * sqrt_omesq * (1.0 - e);
        domega_dt = 0.0;
    }
...
double fm_function(double e, double x, double E0, double Etau)
{
    ...
    double sin_E0_minus_Etau = sin(E0 - Etau);
    double sin_E0_minus_2Etau = sin(E0 - 2*Etau);
    double sin_2E0_minus_Etau = sin(2*E0 - Etau);
    double sin_2E0_minus_2Etau = sin(2*E0 - 2*Etau);
    double sin_3E0_minus_2Etau = sin(3*E0 - 2*Etau);
    double sin_E0_plus_Etau = sin(E0 + Etau);
    double sin_E0_plus_2Etau = sin(E0 + 2*Etau);
    double sin_2E0_plus_Etau = sin(2*E0 + Etau);
    double sin_2E0_plus_2Etau = sin(2*(E0 + Etau));
    double sin_3E0_plus_2Etau = sin(3*E0 + 2*Etau);

    return -(-192*E0 + 576*E0*x - 576*E0*x_p2 - 288*e_p2*E0*x_p2 + 192*E0*x_p3 + 288*e_p2*E0*x_p3 + 72*e_p2*E0*x*(4 - 8*x + (4 + e_p2)*x_p2)*cos(Etau) - 
      96*e*(-1 + x)*(2 - 4*x + (2 + 3*e_p2)*x_p2)*sin(E0) + 6*e_p4*x_p3*sin(2*E0 - 3*Etau) - 8*e_p3*x_p3*sin(3*E0 - 3*Etau) + 
      3*e_p4*x_p3*sin(4*E0 - 3*Etau) + 72*e_p3*x_p2*sin_E0_minus_2Etau - 72*e_p3*x_p3*sin_E0_minus_2Etau - 72*e_p2*x_p2*sin_2E0_minus_2Etau + 
      72*e_p2*x_p3*sin_2E0_minus_2Etau + 24*e_p3*x_p2*sin_3E0_minus_2Etau - 24*e_p3*x_p3*sin_3E0_minus_2Etau - 288*e*x*sin_E0_minus_Etau + 
      576*e*x_p2*sin_E0_minus_Etau - 288*e*x_p3*sin_E0_minus_Etau - 72*e_p3*x_p3*sin_E0_minus_Etau + 72*e_p2*x*sin_2E0_minus_Etau - 144*e_p2*x_p2*sin_2E0_minus_Etau + 
      72*e_p2*x_p3*sin_2E0_minus_Etau + 18*e_p4*x_p3*sin_2E0_minus_Etau - 288*e*x*sin_E0_plus_Etau + 576*e*x_p2*sin_E0_plus_Etau - 288*e*x_p3*sin_E0_plus_Etau - 
      72*e_p3*x_p3*sin_E0_plus_Etau - 72*e_p2*x_p2*sin_2E0_plus_2Etau + 72*e_p2*x_p3*sin_2E0_plus_2Etau - 8*e_p3*x_p3*sin(3*(E0 + Etau)) + 
      72*e_p2*x*sin_2E0_plus_Etau - 144*e_p2*x_p2*sin_2E0_plus_Etau + 72*e_p2*x_p3*sin_2E0_plus_Etau + 18*e_p4*x_p3*sin_2E0_plus_Etau + 
      72*e_p3*x_p2*sin_E0_plus_2Etau - 72*e_p3*x_p3*sin_E0_plus_2Etau + 24*e_p3*x_p2*sin_3E0_plus_2Etau - 24*e_p3*x_p3*sin_3E0_plus_2Etau + 
      6*e_p4*x_p3*sin(2*E0 + 3*Etau) + 3*e_p4*x_p3*sin(4*E0 + 3*Etau))/(192.*M_PI);
}
double fa_function(double e, double x, double E0, double Etau)
{
    ...
    return (192*E0 - 576*E0*x + 576*E0*x_p2 + 288*e_p2*E0*x_p2 - 192*E0*x_p3 - 288*e_p2*E0*x_p3 + 72*e_p2*E0*x*(4 - 8*x + (4 + e_p2)*x_p2)*cos(Etau) - 
     96*e*(-1 + x)*(2 - 4*x + (2 + 3*e_p2)*x_p2)*sin(E0) + 6*e_p4*x_p3*sin(2*E0 - 3*Etau) + 8*e_p3*x_p3*sin(3*E0 - 3*Etau) + 
     3*e_p4*x_p3*sin(4*E0 - 3*Etau) + 72*e_p3*x_p2*sin_E0_minus_2Etau - 72*e_p3*x_p3*sin_E0_minus_2Etau + 72*e_p2*x_p2*sin_2E0_minus_2Etau - 
     72*e_p2*x_p3*sin_2E0_minus_2Etau + 24*e_p3*x_p2*sin_3E0_minus_2Etau - 24*e_p3*x_p3*sin_3E0_minus_2Etau + 288*e*x*sin_E0_minus_Etau - 576*e*x_p2*sin_E0_minus_Etau + 
     288*e*x_p3*sin_E0_minus_Etau + 72*e_p3*x_p3*sin_E0_minus_Etau + 72*e_p2*x*sin_2E0_minus_Etau - 144*e_p2*x_p2*sin_2E0_minus_Etau + 
     72*e_p2*x_p3*sin_2E0_minus_Etau + 18*e_p4*x_p3*sin_2E0_minus_Etau + 288*e*x*sin_E0_plus_Etau - 576*e*x_p2*sin_E0_plus_Etau + 288*e*x_p3*sin_E0_plus_Etau + 
     72*e_p3*x_p3*sin_E0_plus_Etau + 72*e_p2*x_p2*sin_2E0_plus_2Etau - 72*e_p2*x_p3*sin_2E0_plus_2Etau + 8*e_p3*x_p3*sin(3*(E0 + Etau)) + 
     72*e_p2*x*sin_2E0_plus_Etau - 144*e_p2*x_p2*sin_2E0_plus_Etau + 72*e_p2*x_p3*sin_2E0_plus_Etau + 18*e_p4*x_p3*sin_2E0_plus_Etau + 
     72*e_p3*x_p2*sin_E0_plus_2Etau - 72*e_p3*x_p3*sin_E0_plus_2Etau + 24*e_p3*x_p2*sin_3E0_plus_2Etau - 24*e_p3*x_p3*sin_3E0_plus_2Etau + 
...
double fe_function(double e, double x, double E0, double Etau)
{
    ...
    double e_p3 = e*e_p2;
    double e_p4 = e_p2*e_p2;
    double cos_E0_minus_Etau = cos(E0 - Etau);
    double cos_2E0_minus_2Etau = cos(2*E0 - 2*Etau);
    double cos_2Etau = cos(2*Etau);
    double cos_E0_plus_Etau = cos(E0 + Etau);
    double cos_2E0_plus_2Etau = cos(2*(E0 + Etau));
        
    return -((-1 + e_p2)*(12*e*E0*x*(4 - 8*x + (4 + e_p2)*x_p2)*cos(Etau) + 
        (32 - 96*x + 96*x_p2 + 48*e_p2*x_p2 - 32*x_p3 - 48*e_p2*x_p3 + 3*e_p3*x_p3*cos(E0 - 3*Etau) + e_p3*x_p3*cos(3*E0 - 3*Etau) + 
           8*e_p2*x_p2*cos_2E0_minus_2Etau - 8*e_p2*x_p3*cos_2E0_minus_2Etau + 24*e*x*cos_E0_minus_Etau - 48*e*x_p2*cos_E0_minus_Etau + 24*e*x_p3*cos_E0_minus_Etau + 
           6*e_p3*x_p3*cos_E0_minus_Etau + 32*e_p2*x_p2*cos_2Etau - 32*e_p2*x_p3*cos_2Etau + 24*e*x*cos_E0_plus_Etau - 48*e*x_p2*cos_E0_plus_Etau + 
           24*e*x_p3*cos_E0_plus_Etau + 6*e_p3*x_p3*cos_E0_plus_Etau + 8*e_p2*x_p2*cos_2E0_plus_2Etau - 8*e_p2*x_p3*cos_2E0_plus_2Etau + 
           e_p3*x_p3*cos(3*(E0 + Etau)) + 3*e_p3*x_p3*cos(E0 + 3*Etau))*sin(E0)))/(32.*M_PI);
}
double fomega_function(double e, double x, double E0, double Etau)
{
    ...
    double sin_E0_minus_Etau = sin(E0 - Etau);
    double sin_2E0_minus_2Etau = sin(2*E0 - 2*Etau);
    double sin_3E0_minus_Etau = sin(3*E0 - Etau);
    double sin_E0_plus_Etau = sin(E0 + Etau);
    double sin_3E0_plus_Etau = sin(3*E0 + Etau);

    return -(sqrt(1 - e_p2)*x*sin(Etau)*(-48*E0 + 96*E0*x - 48*E0*x_p2 - 12*e_p2*E0*x_p2 + 4*(6 - 12*x + (6 + e_p2)*x_p2)*sin(2*E0) + e_p2*x_p2*sin(4*E0) - 
        2*e_p2*x_p2*sin_2E0_minus_2Etau + e_p2*x_p2*sin(4*E0 - 2*Etau) - 24*e*x*sin_E0_minus_Etau + 24*e*x_p2*sin_E0_minus_Etau + 8*e*x*sin_3E0_minus_Etau - 
        8*e*x_p2*sin_3E0_minus_Etau - 24*e*x*sin_E0_plus_Etau + 24*e*x_p2*sin_E0_plus_Etau - 2*e_p2*x_p2*sin(2*(E0 + Etau)) + 8*e*x*sin_3E0_plus_Etau - 
        8*e*x_p2*sin_3E0_plus_Etau + e_p2*x_p2*sin(4*E0 + 2*Etau)))/(32.*M_PI);
}
...
double ga_function(double e, double x, double E0)
{
    ...
    double e_p3 = e*e_p2;
    double e_p4 = e_p2*e_p2;
    double sin_E0 = sin(E0);
    double sqrt_1_minus_e_p2 = sqrt(1 - e_p2);

    return (4*E0*x*(-8*(3 + (-3 + x)*x) + e_p2*(12 + (-8 + e_p2)*x_p2)) + 64*sqrt_1_minus_e_p2*atan(((1 + e)*tan(E0/2.))/sqrt_1_minus_e_p2) + 
     e*x*(-16*(6 + e_p2*(-3 + x) - 4*x)*x*sin(E0) + e*(8*(3 + x*(-6 + (2 + e_p2)*x))*sin(2*E0) + e*x*(-16*(-1 + x)*sin(3*E0) + 3*e*x*sin(4*E0)))))/(32.*M_PI);
}
double ge_function(double e, double x, double E0)
{
    ...
    return -((-1 + e_p2)*(12*E0*(-2 + e_p2*x*(6 + x*(-9 + (4 + e_p2)*x))) + 48*sqrt_1_minus_e_p2*atan(((1 + e)*tan(E0/2.))/sqrt_1_minus_e_p2) - 
        6*e*(-4 + x*(24 + 8*(-3 + x)*x + e_p2*x*(-15 + 14*x)))*sin(E0) + e_p2*x*(6*(6 + x*(-15 + 2*(4 + e_p2)*x))*sin(2*E0) + e*x*(2*(9 - 10*x)*sin(3*E0) + 3*e*x*sin(4*E0))))
      )/(48.*e*M_PI);
}
double ha_function(double e, double x, double E0)
{
    ...
    return ((8*atan(sqrt(-((1 + e)/(-1 + e)))*tan(E0/2.)))/sqrt(1 - e_p2) + e*(-12*x - (-4 + e_p2)*x_p3 - 4/(-1 + e*cos(E0)))*sin(E0) + 
     x*(-2*E0*(6 + x*(-6 + (2 + e_p2)*x)) - e_p2*x*(-3*(-2 + x)*sin(2*E0) + e*x*sin(3*E0))))/(4.*M_PI);
}
double he_function(double e, double x, double E0)
{
    ...
    double e_p4 = e_p2*e_p2;
    double sqrt_1_minus_e_p2 = sqrt(1 - e_p2);
    double tan_E0_div_2 = tan(E0/2.);
    double sin_2E0 = sin(2*E0);
    double sin_3E0 = sin(3*E0);
    
    return (144*pow(1 - e_p2,1.5)*x*atan(sqrt(-((1 + e)/(-1 + e)))*tan_E0_div_2) + 48*sqrt_1_minus_e_p2*(1 + 3*(-1 + e_p2)*x)*atan(((1 + e)*tan_E0_div_2)/sqrt_1_minus_e_p2) + 
     ((-1 + e_p2)*(-24*E0 - 36*e_p2*E0*x_p2 + 24*e_p2*E0*x_p3 - 12*e*E0*(-2 + e_p2*x_p2*(-3 + 2*x))*cos(E0) - 
          3*e*(-8 + 48*x - 3*(16 + 3*e_p2)*x_p2 + 2*(8 + 7*e_p2)*x_p3)*sin(E0) + 72*e_p2*x*sin_2E0 - 126*e_p2*x_p2*sin_2E0 + 
          60*e_p2*x_p3*sin_2E0 + 16*e_p4*x_p3*sin_2E0 + 27*e_p3*x_p2*sin_3E0 - 26*e_p3*x_p3*sin_3E0 + 4*e_p4*x_p3*sin(4*E0))
...
double XL0_q_function(double q)
{
    ...
    double sqrt_27_plus_q_p2 = sqrt(27 + q_p2);
    
    double Aplus = pow(q*(54 + q_p2 + 6*sqrt_3*sqrt_27_plus_q_p2),0.3333333333333333);
    double Aminus = pow(q*(54 + q_p2 - 6*sqrt_3*sqrt_27_plus_q_p2),0.3333333333333333);
    double sqrt_temp = sqrt(3 + Aminus + Aplus - 2*q);
    return (3 + sqrt_3*sqrt_temp - sqrt_3*sqrt(6 - Aplus - 4*q - q_p2/Aplus + (6*sqrt_3*(1 + q))/sqrt_temp))/6.;
}



/* Old, unoptimised functions */
