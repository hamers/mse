...
class test_mse():
    ...
    def test1(self,args):
        ...
        particles = Tools.create_nested_multiple(N_bodies, [24.0,10.0,7.5],[15.5,600.0],[0.1,0.6],[0.0001,85.0*np.pi/180.0],[85.0*np.pi/180.0,0.01*np.pi/180.0],[0.01,0.01]) ### promising
