...
def parse_arguments():
    ...
    parser.add_argument("--configuration",                            type=str,                   dest="configuration",                     default="fully_nested",             help="Configuration: `fully_nested', `2+2_quadruple', or general (see documentation) ")
    parser.add_argument("--masses", "--ms",                           type=float,  nargs="+",     dest="masses",                            default=[40.0,10.0,2.0],            help="Masses/MSun")
    parser.add_argument("--object_types", "--ots",                    type=int,    nargs="+",     dest="object_types",                      default=[1,1,1],                    help="Object type (integer): 1: star, 2: planet")
    parser.add_argument("--stellar_types", "--sts",                   type=int,    nargs="+",     dest="stellar_types",                     default=[1,1,1],                    help="Initial SSE stellar types (applies to stars only, i.e., object type = 1)")
