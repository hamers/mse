...
class test_mse():
    ...
    def test1(self,args):
        ...
        N_steps = 5000
        stellar_types = [1,1,1]
        Tools.evolve_system(configuration,N_bodies,masses,metallicities,semimajor_axes,eccentricities,inclinations,arguments_of_pericentre,longitudes_of_ascending_node,end_time,N_steps,stellar_types=stellar_types,plot_filename="test1")
    ...
    def test2(self,args):
        ...
        Tools.evolve_system(configuration,N_bodies,masses,metallicities,semimajor_axes,eccentricities,inclinations,arguments_of_pericentre,longitudes_of_ascending_node,end_time,N_steps,stellar_types=stellar_types,plot_filename="test2")
    ...
    def test100(self,args):
        ...
        N_steps = 500
        stellar_types = [1,1,1]
        Tools.evolve_system(configuration,N_bodies,masses,metallicities,semimajor_axes,eccentricities,inclinations,arguments_of_pericentre,longitudes_of_ascending_node,end_time,N_steps,stellar_types=stellar_types,plot_filename="test100")
    ...
    def test101(self,args):
        ...
        N_steps = 500
        stellar_types = [1,1,1]
        Tools.evolve_system(configuration,N_bodies,masses,metallicities,semimajor_axes,eccentricities,inclinations,arguments_of_pericentre,longitudes_of_ascending_node,end_time,N_steps,stellar_types=stellar_types,plot_filename="test101")
    ...
    def test102(self,args):
        ...
        metallicities = [0.01,0.03,0.005]
        #semimajor_axes = [15.5,400.0]
        semimajor_axes = [1.0,20000.0]
        eccentricities = [0.999,0.1]
        inclinations = [0.0001,89.9*np.pi/180.0]
        arguments_of_pericentre = [85.0*np.pi/180.0,0.01*np.pi/180.0]
        longitudes_of_ascending_node = [0.01,0.01]
        end_time = 1.0e7
        #end_time = 1.0e9
        N_steps = 1000
        stellar_types = [14,14,14]
        Tools.evolve_system(configuration,N_bodies,masses,metallicities,semimajor_axes,eccentricities,inclinations,arguments_of_pericentre,longitudes_of_ascending_node,end_time,N_steps,stellar_types=stellar_types,plot_filename="test102")
    ...
    def test103(self,args):
        ...
        metallicities = [0.01,0.03,0.005]
        #semimajor_axes = [15.5,400.0]
        semimajor_axes = [20.0,120.0]
        eccentricities = [0.1,0.3]
        inclinations = [0.0001,10.0*np.pi/180.0]
        arguments_of_pericentre = [85.0*np.pi/180.0,0.01*np.pi/180.0]
        longitudes_of_ascending_node = [0.01,0.01]
        end_time = 1.0e9
        #end_time = 1.0e9
        N_steps = 1000
        stellar_types = [1,1,1]
        Tools.evolve_system(configuration,N_bodies,masses,metallicities,semimajor_axes,eccentricities,inclinations,arguments_of_pericentre,longitudes_of_ascending_node,end_time,N_steps,stellar_types=stellar_types,plot_filename="test103")
    ...
    def test104(self,args):
        ...
        particles = Tools.create_nested_multiple(N_bodies, [7.0,1.0e-3,1.0,2.5],[10.0,1000.0,120000.0],[0.1,0.3,0.3],[0.0001,51.0*np.pi/180.0,123.0*np.pi/180.0],[45.0*np.pi/180.0,0.01*np.pi/180.0,0.01*np.pi/180.0],[0.01,0.01,0.01])
