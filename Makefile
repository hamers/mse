...
CXXSRC = interface.cpp src/types.cpp src/evolve.cpp src/structure.cpp src/ODE_system.cpp src/root_finding.cpp src/newtonian.cpp src/postnewtonian.cpp src/tides.cpp src/external.cpp src/VRR.cpp src/stellar_evolution.cpp src/SNe.cpp src/flybys.cpp src/tools.cpp src/mass_changes.cpp src/binary_evolution.cpp src/merger.cpp src/nbody_evolution.cpp src/test.cpp
